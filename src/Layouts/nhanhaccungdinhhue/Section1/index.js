            ...
            <div className="Section1__title">
                <div className="container">
                    <div className="Section1__title__inner" style={{color:"#FFFFFF"}}>
                        KHÁM PHÁ KHÔNG GIAN NHÃ NHẠC HUẾ 
                    </div>
                </div>
            </div>
                ...
                <div className="container">
                        ...
                        <div className="Section1__content__inner__row">
                            <div className="Section1__content__inner__row__text">
                                <div className="Section1__content__inner__title" style={{color:"#FFFFFF"}}>
                                    Linh hồn của nghi lễ cung đình
                                </div>
                                <div className="Section1__content__inner__text" style={{color:"#FFFFFF"}}>
                                    Nhã nhạc cung đình là thể loại nhạc có từ thời phong kiến được biểu diễn phục vụ trong cung đình vào những dịp lễ. Nhạc có lời hát tao nhã cùng điệu thức cao sang, quý phái góp phần tạo sự trang trọng cho các buổi lễ. Đây còn là biểu tượng của vương quyền và sự trường tồn, hưng thịnh của triều đại. Chính vì thế, Nhã nhạc cung đình Huế rất được các triều đại phong kiến Việt Nam coi trọng.
                                </div>
                                <div className="Section1__content__inner__text" style={{color:"#FFFFFF"}}>
                                    Loại hình này không chỉ là âm nhạc mà còn là linh hồn của các nghi lễ cung đình, góp phần tạo nên vẻ uy nghiêm và trang trọng. Trang nghiêm mà gần gũi, dân dã nên Nhã nhạc Việt Nam được ưa thích, lưu truyền từ thế kỷ này sang thế kỷ khác.
                                </div>
                            </div>
                    ...
                    <div className="Section1__content__inner inner2">
                        <div className="Section1__content__inner__row">
                            <div className="Section1__content__inner__row__text">
                                <div className="Section1__content__inner__title" style={{color:"#FFFFFF"}}>
                                    Ba hình thức biểu diễn độc đáo
                                </div>
                                <div className="Section1__content__inner__text" style={{color:"#FFFFFF"}}>
                                    Nhã nhạc cung đình Huế hiện nay tồn tại dưới ba hình thức biểu diễn chính:
                                </div>
                                <div className="Section1__content__inner__text" style={{color:"#FFFFFF"}}>
                                    Dàn Đại nhạc: Là dàn nhạc rất quan trọng trong hệ thống Nhã nhạc cung đình Huế, thường được sử dụng trong các lễ tế quan trọng của triều đình, có âm hưởng hùng tráng, nhạc cụ chủ yếu là dàn trống và kèn. 
                                </div>
                                <div className="Section1__content__inner__text" style={{color:"#FFFFFF"}}>
                                    Dàn Tiểu nhạc: Các bản âm nhạc của dàn Tiểu nhạc mang màu sắc trang nhã, vui tươi, thường sử dụng trong các buổi yến tiệc của triều đình, lễ Đại Khánh, tết Nguyên Đán. Chất liệu dễ đi vào lòng người, không quá trang nghiêm hoặc sầu bi, âm lượng không quá lớn. Nhạc cụ chủ yếu là sinh tiền, sáo, đàn nguyệt, đàn tỳ bà, đàn tam huyền, đàn nhị…
                                </div>
                                <div className="Section1__content__inner__text" style={{color:"#FFFFFF"}}>
                                    Múa cung đình: Múa cung đình triều Nguyễn chủ yếu là múa tập thể, tư tưởng chủ đề thường biểu hiện ở các đội hình di chuyển và kết thúc bằng một đội hình ngưng đọng. Một số điệu múa cung đình nổi bật là múa Bát Dật, múa Lục Cúng Hoa Đăng, múa Lân Mẫu Xuất Lân Nhi.
                                </div>
                            </div>
                            <div className="Section1__content__inner__row__image">
                                ...
                                <div className="Section1__content__inner__video__disc" style={{color:"#FFFFFF"}}>
                                    Nguồn: <b>Thông tấn xã Việt Nam (Thế Duyệt)</b>
                                </div>
                            </div>
                        </div>
                        {/* <div className="Section1__content__inner__text">
