            ...
            <div className="Section1__title">
                <div className="container">
                    <div className="Section1__title__inner">
                        KHAI PHÁ NHỮNG CÔNG TRÌNH BÍ ẨN 
                    </div>
                </div>
            </div>
            ...
            <div className="Section1__menu">
                <div className="container">
                    <div className="Section1__menu__inner">
                        <label className="Section1__menu__inner__tab lable1" for="inner1">Di tích Kỳ đài (Cột cờ Hà Nội)</label>
                        <label className="Section1__menu__inner__tab lable2" for="inner2">Di tích nền điện Kính Thiên</label>
                        ...
                        <div className="Section1__content__inner__row">
                            ...
                            <div className="Section1__content__inner__row__image">
                                <div className="Section1__content__inner__image" >
                                    <img src="/image/hoangthanhthanglong/3.1.png" />
                                </div>
                                <div className="Section1__content__inner__video__disc">
                                    Ảnh: <b>“Di tích Kỳ đài nằm trong khuôn viên Bảo tàng Lịch sử Quân sự Việt Nam”</b>
                                </div>
                                <div className="Section1__content__inner__video__disc">
                    ...
                    <div className="Section1__content__inner inner2">
                        <div className="Section1__content__inner__row">
                            <div className="Section1__content__inner__row__text">
                                ...
                                <div className="Section1__content__inner__text">
                                    Điện Kính Thiên là di tích trung tâm trong Hoàng thành Thăng Long. Đây là cung điện quan trọng bậc nhất, nơi cử hành các nghi lễ long trọng nhất của triều đình, nơi đón tiếp sứ giả nước ngoài và là nơi thiết triều bàn những việc quốc gia đại sự.
                                </div>
                                <div className="Section1__content__inner__text">
                            ...
                            <div className="Section1__content__inner__row__image">
                                ...
                                <div className="Section1__content__inner__video__disc">
                                    Video: <b>“Khôi phục điện Kính Thiên”</b>
                                </div>
                            </div>
                        </div>
                        {/* <div className="Section1__content__inner__text">
