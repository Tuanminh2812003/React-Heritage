                        ...
                        <div className="Section1__content__inner__row">
                            <div className="Section1__content__inner__row__text">
                                ...
                                <div className="Section1__content__inner__text">
                                    Cửu đỉnh được triều đình nhà Nguyễn dựng lên vào tháng 10 năm 1835 dưới thời vua Minh Mạng, kéo dài tới đầu năm 1837 mới hoàn thành. Ngày 04/03/1837, triều đình nhà Nguyễn tổ chức lễ khánh thành và an vị cho Cửu đỉnh dưới sự chủ lễ của vua Minh Mạng.
                                </div>
                                <div className="Section1__content__inner__text">
                                    Mỗi chiếc đỉnh tượng trưng cho một phần lịch sử, văn hóa và các sự kiện quan trọng của triều đại này. Các bản đúc nổi trên đỉnh ghi lại những sự kiện này, từ các chiến công đến các nghi lễ triều đình, là chứng nhân lịch sử của nhà Nguyễn.
                                </div>
                            </div>
                    ...
                    <div className="Section1__content__inner inner2">
                        <div className="Section1__content__inner__row">
                            <div className="Section1__content__inner__row__text">
                                ...
                                <div className="Section1__content__inner__text">
                                    Cửu đỉnh được coi như biểu trưng và là pháp khí của triều đình nhà Nguyễn đương thời. Bản đúc nổi trên cửu đỉnh tại Huế là dương bản duy nhất, hiện đặt trước sân Thế Tổ Miếu trong Hoàng cung Huế, gồm 162 hình ảnh và chữ Hán. Đặc biệt để đề cao thân phận người phụ nữ, vua Minh Mạng đã dùng hình thức đặt tên người phụ nữ lên dòng kênh để ghi dấu công lao. Các đỉnh được đặt tên lần lượt là: Cao đỉnh, Nhân đỉnh, Chương đỉnh, Anh đỉnh, Nghị đỉnh, Thuần đỉnh, Tuyên đỉnh, Dụ đỉnh, Huyền đỉnh.
                                </div>
                                <div className="Section1__content__inner__text">
                                    Hiện nay, điện Kính Thiên chỉ còn lại nền cũ và hai bậc thềm rồng đá, nhưng vẫn thể hiện rõ dấu ấn quyền uy của kinh đô xưa với kiến trúc độc đáo: hai bên là rồng mây cách điệu, biểu trưng cho trời đất và vũ trụ; lan can chạm khắc hoa sen, uyên ương, sóng nước, cá hóa rồng – những họa tiết mang đậm giá trị văn hóa và nghệ thuật cung đình.
                                </div>
                            </div>
                            <div className="Section1__content__inner__row__image">
                                <div className="Section1__content__inner__image" >
