...
function Section1(){
    return(
        <>
        <div style={{backgroundColor: "#FEF2F2", padding: "40px 0px"}}>
                        ...
                        <div className="Section1__content__inner__row">
                            <div className="Section1__content__inner__row__text">
                                <div className="Section1__content__inner__title">
                                    Di tích lịch sử nổi tiếng xứ Thanh
                                </div>
                                <div className="Section1__content__inner__text">
                                    Thành nhà Hồ được coi là một trong những tòa thành bằng đá độc đáo bậc nhất Việt Nam và trên thế giới, sử dụng tới 20.000 m3 đá để xây dựng và gần 100.000 m3 đất được đào đắp. Thành nội có hình chữ nhật dài 870,5m theo chiều Bắc - Nam và 883,5m theo chiều Đông - Tây. Trải qua 6 thế kỷ tồn tại, phần kiến trúc bên trong đã bị hủy hoại, vùi lấp hết song 4 bức tường thành vẫn giữ được tương đối nguyên vẹn.
                                </div>
                                <div className="Section1__content__inner__text">
                                    Hoàng thành bao gồm 4 cổng chính Đông, Tây, Nam, Bắc và toàn bộ tường thành bao quanh đều được xây dựng bằng những phiến đá vôi có trọng lượng đến hàng tấn. Bốn cổng thành được xây theo kiểu mái vòm cuốn sử dụng các phiến đá lớn được xếp múi cao.
                                </div>
                            </div>
                    ...
                    <div className="Section1__content__inner inner2">
                        <div className="Section1__content__inner__row">
                            <div className="Section1__content__inner__row__text">
                                ...
                                <div className="Section1__content__inner__text">
                                    Hào thành bao bên ngoài Hoàng thành, cách chân thành chừng 50m, rộng khoảng hơn 90m với phần đáy rộng 52m, sâu hơn 6.5m. Hào thành được xây dựng bằng đá hộc và đá dăm lót ở phía dưới để giữ được độ chắc chắn, vững trãi, có chức năng bảo vệ nội thành.
                                </div>
                            </div>
                            <div className="Section1__content__inner__row__image">
                                <div className="Section1__content__inner__image" >
                                ...
                                <div className="Section1__content__inner__video__disc">
                                    Nguồn: <b>Báo Tin Tức (XM-MH/Báo Tin tức)</b>
                                </div>
                            </div>
                        </div>
                        {/* <div className="Section1__content__inner__text">
                        ...
                        <div className="Section1__content__inner__row">
                            ...
                            <div className="Section1__content__inner__row__image">
                                <div className="Section1__content__inner__video" style={{marginBottom: "0px", marginTop: "0px"}}>
                                    ...
                                    <iframe width="100%" height="200px" src="https://www.youtube.com/embed/CqIT9ebon5c?si=Ch_Eky4Fmd2PR8f7" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                    <div className="Section1__content__inner__video__disc">
                                        Video: <b>"Thành Nhà Hồ - di sản văn hóa thế giới"</b>
                                    </div>
                                </div>
                            </div>
                        </div>
