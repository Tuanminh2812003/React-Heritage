function Section5(){
    return(
        <>
            <div className="Section5" style={{backgroundColor: "#F3E7DB", paddingTop: "40px"}}>
                <div className="container">
                    <div className="Section5__inner">
                        ...
                        <div className="Section5__inner__row1">
                            ...
                            >                                
                                <iframe width="100%" height="400px" src="https://www.youtube.com/embed/KlkYkakChMI?si=BqILwzM4celYzcAp" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                <div className="Section1__content__inner__video__disc" style={{color: "#374151"}}>
                                    Nguồn: <b>Cổng thông tin Quốc hộ</b>
                                </div>
                            </div>
                        </div>
