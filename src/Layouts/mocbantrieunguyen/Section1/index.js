                ...
                <div className="container">
                    ...
                    <div className="Section1__content__inner inner2">
                        <div className="Section1__content__inner__row">
                            <div className="Section1__content__inner__row__text">
                                <div className="Section1__content__inner__title">
                                    Quy trình chế tác Mộc bản
                                </div>
                                <div className="Section1__content__inner__text">
                                    Để biên soạn các bộ quốc sử, thực lục các triều vua và các sách chuyên khảo về địa chí, văn hóa, giáo dục theo lệnh vua, triều đình đã thiết lập một bộ máy biên tập với sự đứng đầu của các văn võ đại thần. Đồng thời, quá trình này còn tuân theo hàng loạt quy chế nghiêm ngặt về soạn thảo, san khắc, in ấn và tuyển chọn thợ khắc.
                                </div>
                                <div className="Section1__content__inner__text">
                                    Việc biên soạn mỗi bộ chính sử thường kéo dài hàng thập kỷ, trải qua nhiều triều đại, đòi hỏi công sức và trí tuệ của nhiều sử thần. Chẳng hạn, phần Tiền biên của bộ Đại Nam thực lục mất 25 năm để hoàn thành, từ năm Minh Mệnh thứ 2 (1821) đến năm Thiệu Trị thứ 4 (1844). Trong khi đó, phần Chính biên khởi sự từ năm 1821 và kéo dài đến tận đời vua Khải Định (1916 – 1925) mới hoàn thành phần thất kỷ. Như vậy, quá trình biên soạn bộ Đại Nam Thực lục đã kéo dài gần 100 năm mới hoàn thành bản thảo
                                </div>
                            </div>
                            <div className="Section1__content__inner__row__image">
