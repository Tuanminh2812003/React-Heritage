                        ...
                        <div className="Section1__content__inner__row">
                            <div className="Section1__content__inner__row__text">
                                ...
                                <div className="Section1__content__inner__text">
                                    Đờn ca tài tử Nam Bộ hình thành và phát triển từ cuối thế kỷ 19, bắt nguồn từ nhạc lễ, nhã nhạc cung đình Huế và văn học dân gian. Loại hình nghệ thuật này được phát triển mạnh mẽ ở 21 tỉnh, thành phố phía Nam Việt Nam, bao gồm:
                                </div>
                                <div className="Section1__content__inner__text">
                                    - Miền Đông Nam Bộ: Thành phố Hồ Chí Minh, Bình Dương, Bình Phước, Đồng Nai, Bà Rịa - Vũng Tàu, Tây Ninh.
                                </div>
                                <div className="Section1__content__inner__text">
                                    - Miền Tây Nam Bộ (Đồng bằng sông Cửu Long): Long An, Tiền Giang, Bến Tre, Vĩnh Long, Trà Vinh, Đồng Tháp, An Giang, Kiên Giang, Hậu Giang, Sóc Trăng, Bạc Liêu, Cà Mau.
                                </div>
                                <div className="Section1__content__inner__text">
                                    - Một số tỉnh miền Trung: Bình Thuận, Ninh Thuận (đôi khi cũng được xem là nơi có đờn ca tài tử, tuy nhiên không phổ biến bằng các tỉnh Nam Bộ).
                                </div>
                                <div className="Section1__content__inner__text">
                                    Trong đó, các tỉnh được xem là cái nôi của đờn ca tài tử Nam Bộ bao gồm:
                                </div>
                                <div className="Section1__content__inner__text">
                                    - Long An: Nơi sản sinh ra nhiều nghệ nhân, thầy đờn nổi tiếng.
                                </div>
                                <div className="Section1__content__inner__text">
                                    - Bạc Liêu: Quê hương của cố nhạc sĩ Cao Văn Lầu, tác giả bài Dạ cổ hoài lang, được xem là bài vọng cổ đầu tiên và là một trong những bài bản quan trọng nhất của đờn ca tài tử.
                                </div>
                                <div className="Section1__content__inner__text">
                                    - Thành phố Hồ Chí Minh (Sài Gòn xưa): Trung tâm văn hóa, nơi đờn ca tài tử phát triển mạnh mẽ và lan tỏa ra các tỉnh thành khác.
                                </div>
                                <div className="Section1__content__inner__text">
                                    - Tiền Giang, Bến Tre: cũng là nơi có truyền thống đờn ca tài tử lâu đời.
                                </div>
                            </div>
                            <div className="Section1__content__inner__row__image">
                                ...
                                <div className="Section1__content__inner__video" style={{marginTop:"0px"}}>
                                    <iframe width="100%" height="200px" src="https://www.youtube.com/embed/uB6ye79H9C0?si=GgXdaq25sfJ2Jjab" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                </div>
                                <div className="Section1__content__inner__video__disc">
                                    Video: <b>“Đờn ca tài tử Nam Bộ”</b>
                                </div>
                            </div>
                        </div>
                        {/* <div className="Section1__content__inner__text">
                    ...
                    <div className="Section1__content__inner inner2">
                        <div className="Section1__content__inner__row">
                            <div className="Section1__content__inner__row__text">
                                ...
                                <div className="Section1__content__inner__text">
                                    Đờn ca tài tử Nam Bộ là loại hình nghệ thuật dân gian độc đáo, kết tinh từ tinh hoa âm nhạc cung đình Huế, nhạc lễ Nam Bộ và văn học dân gian. Được UNESCO công nhận là Di sản Văn hóa Phi vật thể Đại diện của Nhân loại năm 2013, đờn ca tài tử không chỉ là nghệ thuật biểu diễn mà còn là một phần không thể thiếu trong đời sống tinh thần của người dân Nam Bộ. Loại hình này phản ánh tình cảm con người với thiên nhiên, lịch sử và xã hội, thể hiện qua những giai điệu mượt mà, lời ca sâu lắng, đậm chất trữ tình và nhân văn.
                                </div>
                            </div>
                            <div className="Section1__content__inner__row__image">
                    ...
                    <div className="Section1__content__inner inner3">
                        <div className="Section1__content__inner__row">
                            <div className="Section1__content__inner__row__text">
                                ...
                                <div className="Section1__content__inner__text">
                                    Đờn ca tài tử ra đời vào cuối thế kỷ XIX, khi các nhạc sĩ cung đình Huế di cư vào Nam sau phong trào Cần Vương. Họ kết hợp nhã nhạc triều Nguyễn với âm nhạc dân gian địa phương, tạo nên phong cách độc đáo. Ban đầu, loại hình này chỉ có đàn, sau mới phát triển thêm phần ca. Tên gọi "tài tử" xuất phát từ tinh thần "nghệ thuật vị nghệ thuật"—người chơi đờn ca không vì mưu sinh mà vì đam mê, tài năng.
                                </div>
                                <div className="Section1__content__inner__text">
                                    Giai Đoạn Phát Triển
                                </div>
                                <div className="Section1__content__inner__text">
                                    - Cuối thế kỷ XIX – đầu thế kỷ XX: Hình thành từ nhạc lễ và nhã nhạc cung đình, được cải biên thành 20 bài tổ (nhị thập huyền tổ bản), bao gồm 6 bài Bắc, 3 bài Nam, 4 bài Oán và 7 bài Hạ.
                                </div>
                                <div className="Section1__content__inner__text">
                                    - Thế kỷ XX: Phát triển mạnh mẽ, lan rộng khắp 21 tỉnh Nam Bộ, trở thành nguồn cảm hứng cho sân khấu cải lương.
                                </div>
                                <div className="Section1__content__inner__text">
                                    - Năm 2013: Được UNESCO vinh danh, khẳng định giá trị toàn cầu.
                                </div>
                            </div>
                            <div className="Section1__content__inner__row__image">
                                <div className="Section1__content__inner__image" >
